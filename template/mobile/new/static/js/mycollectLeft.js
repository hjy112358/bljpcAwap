(function ($) {
    ...
    $.fn.slideEle = function (_aoConfig) {
        ...
        var slideDel = function () {
            ...
            //     $("<a class='spnbtn spnDel' style='position: absolute;top:0;background: #f60000;width: " + defaults.tagWidth + "px;height: 100%;right: -" + current.twoWidth + "px; z-index: 99999;'>删除</a>").appendTo(defaults.slideBars);
            // } else {
                current.twoWidth = defaults.tagWidth
                $("<a class='spnbtn spnDel' style='width: " + defaults.tagWidth + "px;right: -" + current.twoWidth + "px; '>删除</a>").appendTo(defaults.slideBars);
            // }
            defaults.slideBars.each(function (i) {
                var $this = $(this);
                $this.find(".spnDel").on("click", function (e) {
                    var _this=$(this);
                    var delId=_this.parent().attr("data-id")
                    console.log(delId)
                    //删除
