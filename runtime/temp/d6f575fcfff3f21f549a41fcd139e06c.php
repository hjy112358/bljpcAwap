<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:51:"./template/mobile/new/activity\flash_sale_list.html";i:1562851643;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	...
	<body>
		<div class="classreturn loginsignup">
			<div class="content">
				...
				<div class="ds-in-bl search center" style="margin-left: 30px">
					<span>秒杀</span>
				</div>
		...
		<div class="floor killtime p">
			<div class="content30">
				<ul>
					<?php if(is_array($time_space) || $time_space instanceof \think\Collection): $i = 0; $__LIST__ = $time_space;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
