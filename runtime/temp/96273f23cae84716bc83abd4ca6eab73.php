<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:39:"./template/mobile/new/user\account.html";i:1556698550;s:40:"./template/mobile/new/public\header.html";i:1556698550;s:38:"./template/mobile/new/public\menu.html";i:1556698550;}*/ ?>
<!DOCTYPE html >
<html>
<head>
...
<div class="Funds">
  ...
  <?php if(is_array($account_log) || $account_log instanceof \think\Collection): if( count($account_log)==0 ) : echo "" ;else: foreach($account_log as $k=>$item): ?>
    <li class="Funds_li" <?php if($k == count($account_log)): ?> style="border:0"<?php endif; ?>>
        ...
        <span>增加,<em><?php echo $item['pay_points']; ?></em></span>
