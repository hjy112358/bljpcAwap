<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:40:"./template/mobile/new/user\feedback.html";i:1558507840;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="">
    <div class="wrap">
        ...
        <div class="maincolorbg flex jus-between align-c tophead">
            ...
            <p class="font-18">意见反馈</p>
            <span class="font-16">发送</span>
        </div>


        <div class="datelist feedback">
            <div class="flex jus-between  ">
                <textarea name="" id="" cols="30" rows="10" placeholder="请输入您对我们的建议与意见···"></textarea>
            </div>
