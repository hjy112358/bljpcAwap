<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./template/mobile/new/location\location.html";i:1557930271;s:40:"./template/mobile/new/public\footer.html";i:1556698550;s:44:"./template/mobile/new/public\footer_nav.html";i:1557372944;s:42:"./template/mobile/new/public\wx_share.html";i:1556698550;}*/ ?>
<!DOCTYPE html >
<html>
<head>
	...
	<!--引入高德地图JSAPI -->
	<script src="//webapi.amap.com/maps?v=1.4.13&key=4a66ce96cf75144d7cd27fbfa42429b6"></script>
	<!--引入UI组件库（1.0版本） -->
...
<div id="tbh5v0">
   ...
   <div class="register">
		<div class="locationCity pos-r">
			<p>定位城市</p>
		</div>
		<div class="registerinput locationBox">
            <div class="autolocation">
                <img src="__STATIC__/images/newimg/automatic.png" alt="">
                <p>自动获取地址</p>
            </div>
			<div class="lastInput flex jus-center align-c">
                <img src="__STATIC__/images/newimg/loactionImg.png" alt="" class="margin-r10">
                <span>南通市</span>
			</div>
			
			<div class="nextStep">
				<a href="javascript:void(0)">进入</a>
			</div>
