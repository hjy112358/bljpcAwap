<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:37:"./template/mobile/new/cart\cart4.html";i:1561541654;s:40:"./template/mobile/new/public\footer.html";i:1556698550;s:44:"./template/mobile/new/public\footer_nav.html";i:1560504668;s:42:"./template/mobile/new/public\wx_share.html";i:1556698550;}*/ ?>
<!DOCTYPE html>
<html>
...
<body style="background: rgb(235, 236, 237);position:relative;padding-bottom:40px">
  <div class="tab_nav">
    <!-- <div class="header"> -->
      <!-- <div class="h-left">
  ...
  <div class="screen-wrap fullscreen login">
        ...
        <div class="con-ct   fo-con">
          ...
          <ul class="ct-list">
            ...
            <li>支付金额：
              <em>
                <?php if($master_order_sn != ''): ?>
                  ￥<?php echo $sum_order_amount; ?>元
                  <?php else: ?>
                  ￥<?php echo $order['order_amount']; ?>元
                <?php endif; ?>
              </em>
            </li>
          </ul>
              ...
              <div class="panel panel-default info-box">
                <div class="panel-body" id="pay_div"  >
                  ...
                  <?php if(is_array($paymentList) || $paymentList instanceof \think\Collection): if( count($paymentList)==0 ) : echo "" ;else: foreach($paymentList as $k=>$v): ?> 
                   ...
                   <li class="clearfix" name="payment_name">
                      <label>
                          <input type="radio"   value="yue" class="c_checkbox_t" name="pay_radio" />
                          <div class="fl shipping_title">
                            <span>余额支付</span>
                            <!-- <img src="/plugins/<?php echo $v['type']; ?>/<?php echo $v['code']; ?>/<?php echo $v['icon']; ?>" onClick="change_pay(this);" width="110" height="40" /> -->
    ...
    function change_pay(obj)
    {
      ...
      function pay() {
        var master_order_sn = "<?php echo $master_order_sn; ?>";
        var order_id = "<?php echo $order_id; ?>";
        if ($("input[name='pay_radio']:checked").val() == 'yue') {
          $.ajax({
            url: "<?php echo url('cart/payticket'); ?>",
            data: { master_order_sn: master_order_sn, order_id: order_id },
            success: function (data) {
              if (data['status'] == '1') {
                ...
                if (data['data']) {
                  ...
                  window.location.href = "/mobile/order/orderPayStatus/status/2";
                } else {
                  alert(data['msg']);
                  window.location.href = "/mobile/order/orderPayStatus/status/2";
                }
