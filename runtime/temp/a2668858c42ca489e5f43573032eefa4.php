<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"./application/seller/new/goods\_goods.html";i:1491382652;s:41:"./application/seller/new/public\head.html";i:1491382652;s:41:"./application/seller/new/public\left.html";i:1491382652;s:41:"./application/seller/new/public\foot.html";i:1557888501;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
                ...
                <form method="post" id="addEditGoodsForm" >
                    ...
                    <div class="ncsc-form-goods active" id="tab_tongyong">
                        ...
                        <dl>
                            ...
                            <dd>
                                <p>
                                    <input type="text" value="<?php echo $goodsInfo['goods_sn']; ?>" name="goods_sn" class="text">
                                </p>
                        ...
                        <dl>
                            ...
                            <dd>
                                <select name="cat_id1" id="cat_id1" onfocus="get_category2(this.value,'cat_id2','0');" onchange="get_category2(this.value,'cat_id2','0');">
                                    <option value="0">请选择商品分类</option>
                                    <?php if(is_array($cat_list) || $cat_list instanceof \think\Collection): if( count($cat_list)==0 ) : echo "" ;else: foreach($cat_list as $k=>$v): ?>
                                        <option value="<?php echo $v['id']; ?>" <?php if($v['id'] == $goodsInfo['cat_id1']): ?>selected="selected"<?php endif; ?> >
                                        <?php echo $v['name']; ?>
                                        </option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                                <select name="cat_id2" id="cat_id2" onfocus="get_category2(this.value,'cat_id3','0');" onchange="get_category2(this.value,'cat_id3','0');">
                                    <option value="0">请选择商品分类</option>
                                </select>
                        ...
                        <dl>
                            ...
                            <dd>
                                <select name="brand_id" id="brand_id">
                                    ...
                                    <?php if(is_array($brandList) || $brandList instanceof \think\Collection): if( count($brandList)==0 ) : echo "" ;else: foreach($brandList as $k=>$v): if($v['status'] == 0): ?>
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <p class="hint">兑换该商品可使用多少积分，积分比例1元:<?php echo $tpshop_config[shopping_point_rate]; ?>分</p>
                            </dd>
                        </dl>
                        <dl>
                            <dt>商品关键词：</dt>
                        ...
                        <dl class="special-01">
				     	...
				     	<dl class="special-01" nctype="virtual_valid" style="display: none;">
					        ...
					        <dd>
					          <input type="text" name="virtual_indate" id="virtual_indate" class="w80 text hasDatepicker" value="<?php echo date('Y-m-d',$goodsInfo[virtual_indate]); ?>" readonly="readonly"><em class="add-on"><i class="icon-calendar"></i></em>
					          <span></span>
					    ...
					    <dl class="special-01" nctype="virtual_valid" style="display: none;">
					        ...
					        <dd>
					          <input type="text" name="virtual_limit" id="virtual_limit" class="w80 text" value="<?php echo $goodsInfo['virtual_limit']; ?>">
					          <span></span>
                                ...
                                <div class="ncsc-form-goods-pic">
									<div class="container">
								        ...
								        <div class="clabackkj">
									      ...
									      <?php endforeach; endif; else: echo "" ;endif; if($image_count < 5): $__FOR_START_21894__=$image_count;$__FOR_END_21894__=5;for($i=$__FOR_START_21894__;$i < $__FOR_END_21894__;$i+=1){ ?>
										      	<li class="ncsc-goodspic-upload">
									            <div class="upload-thumb"><a onclick="" href="#" target="_blank"><img nctype="file_<?php echo $i; ?>" src="/public/static/images/default_goods_image_240.gif"></a>
									            ...
									            <div class="ncsc-upload-btn"><a href="javascript:void(0);" onclick="img_upload(10, 'file_<?php echo $i; ?>', 'goods', 'call_back2');"><span></span><p><i class="icon-upload-alt"></i>上传</p>
									              </a>
										             </div>
										         </li>
										  <?php } endif; ?>
...
//			data:{goods_id:goods_id,cat_id3:cat_id3},
    ...
    $(document).ready(function(){
        ...
        // 商品分类第二个下拉菜单
        <?php if($goodsInfo['cat_id2'] > 0): ?>
                get_category2("<?php echo $goodsInfo['cat_id1']; ?>",'cat_id2',"<?php echo $goodsInfo['cat_id2']; ?>");
        <?php endif; ?>

        // 商品分类第三个下拉菜单
        <?php if($goodsInfo['cat_id3'] > 0): ?>
                get_category2("<?php echo $goodsInfo['cat_id2']; ?>",'cat_id3',"<?php echo $goodsInfo['cat_id3']; ?>");
        <?php endif; ?>
        ...
        // 如果是编辑的时候 加载 规格 和属性
        <?php if($goodsInfo['cat_id3'] > 0): ?>
                ajaxGetSpecAttr(<?php echo $goodsInfo['goods_id']; ?>,<?php echo $goodsInfo['cat_id3']; ?>);
        <?php endif; ?>
		...
		$("#addEditGoodsForm").validate({
            ...
            submitHandler: function(form){   //表单提交句柄,为一回调函数，带一个参数：form
            	...
            	ajax_submit_form('addEditGoodsForm','<?php echo U('Goods/addEditGoods?is_ajax=1'); ?>');
            },  
