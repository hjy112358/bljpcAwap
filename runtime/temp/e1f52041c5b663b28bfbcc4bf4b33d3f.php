<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"./application/seller/new/comment\ajaxindex.html";i:1491382652;}*/ ?>
<table class="ncsc-default-table">
    ...
    <tbody>
    <?php if(is_array($comment_list) || $comment_list instanceof \think\Collection): $i = 0; $__LIST__ = $comment_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
        <tr class="bd-line">
