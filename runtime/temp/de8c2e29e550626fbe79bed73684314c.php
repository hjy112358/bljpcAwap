<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:39:"./template/mobile/new/goods\search.html";i:1556698550;s:44:"./template/mobile/new/public\footer_nav.html";i:1556768256;s:42:"./template/mobile/new/public\wx_share.html";i:1556698550;}*/ ?>
<html>
<head>
      ...
      <?php if($filter_price != null): ?>
		        ...
		        <ul class="clearfix filtrate_address filtrate_list att_item">
			       <?php if(is_array($filter_price) || $filter_price instanceof \think\Collection): if( count($filter_price)==0 ) : echo "" ;else: foreach($filter_price as $k=>$v): ?>
			        <li>
			            <a  href="<?php echo $v[href]; ?>"><?php echo $v[value]; ?>元</a>
			        </li>
			        <?php endforeach; endif; else: echo "" ;endif; ?>
		        </ul>                       
      <?php endif; ?>
