<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"./application/seller/new/plugin\index.html";i:1491382652;s:41:"./application/seller/new/public\head.html";i:1559726203;s:41:"./application/seller/new/public\left.html";i:1491382652;s:41:"./application/seller/new/public\foot.html";i:1557888501;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            ...
            <form method="post" id="addEditGoodsForm">
                ...
                <tbody>
                <?php if(empty($shipping) || ($shipping instanceof \think\Collection && $shipping->isEmpty())): ?>
                <tr>
                    <td colspan="20" class="norecord"><div class="warning-option"><i class="icon-warning-sign"></i><span>无物流插件，请向平台咨询。</span></div></td>
                </tr>
                <?php else: if(is_array($shipping) || $shipping instanceof \think\Collection): $i = 0; $__LIST__ = $shipping;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?>
                    <tr class="bd-line">
