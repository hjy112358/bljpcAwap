<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./template/mobile/new/user\edit_address.html";i:1562900027;s:38:"./template/mobile/new/public\menu.html";i:1556698550;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="tab_nav">
          ...
          <div class="h-right">
            ...
            <!-- <div class="maincolorbg tophead " id="topAnchor" style="text-align: center;">
                <p class="font-18" style="margin-left:0">地址管理</p>
            </div> -->
