...
<div class="endorse_hend">
	<p>我发展的<?php echo $_GET['level']; ?>级（<?php echo $count; ?>）人</p>
</div>

<div class="Wallet">
	<div class="endorse_dyr">
		<form action="<?php echo U('Distribut/lower_list',array('level'=>$_GET['level'])); ?>" method="post" id="filter_form">
		...
		<?php if(is_array($list) || $list instanceof \think\Collection): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$v): ?> 
            <div class="endorse_num">
                <div class="hend_endor">
                    <img src="<?php echo (isset($v['head_pic']) && ($v['head_pic'] !== '')?$v['head_pic']:"__STATIC__/images/hend_none.png"); ?>" width="60" height="60" />
                </div>
                <div class="sec_endor">
...
var  page = 1;
 ...
 {	 	 	 
		...
		$.ajax({
			type : "POST",			
			url:"/index.php?m=Mobile&c=Distribut&a=lower_list&level=<?php echo $_GET['level']; ?>&is_ajax=1&p="+page,//+tab,
