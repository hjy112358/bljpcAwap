<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:38:"./template/mobile/new/store\store.html";i:1559006730;s:44:"./template/mobile/new/public\foot_store.html";i:1558922128;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
    <div class="wrap">
        ...
        <div class="storemsg maincolorbg flex jus-between align-c">
            ...
            <p class="attention font-13" onclick="collects()" id="guanzhu">
                <?php if(($is_collect == 1) and ($is_show == 1)): ?>已关注
                    <?php else: ?>关注<?php endif; ?>
            </p>
        </div>
        ...
        <div id="page" class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide slidepage">
                    ...
                    <div class="indexlit">
                        <img src="<?php echo $store_detail['store_adv']; ?>" alt="">
                        <div class="classifybox">
                            ...
                            <div class="levelSec">
                                ...
                                <div id="focus" class="focus storefocus">
                                    <div class="hd">
                                        <ul>
                                            <li class=""></li>
                                            <li class="on"></li>
                                    ...
                                    <div class="bd">
                                        <div class="tempWrap" style="overflow:hidden; position:relative;">
                                            <ul
                                                style="width: 960px; position: relative; overflow: hidden; padding: 0px; margin: 0px; transition-duration: 200ms; transform: translate(-320px, 0px) translateZ(0px);">
                                                <?php if(is_array($store_banner) || $store_banner instanceof \think\Collection): $i = 0; $__LIST__ = $store_banner;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                    <li style="display: table-cell; vertical-align: top; width: 320px;">
                                                        <a href="javascript:void(0)"><img src="<?php echo $vo['banner_url']; ?>"></a>
                                                    </li>
                        ...
                        <div class="goodsimgs">
                            <?php echo $store_detail['store_content']; ?>
                        </div>
                    </div>
                                ...
                                <div class="goodslist">
                                    <ul class="clearfix">
                                        <li>
                                            ...
                                            <div class="flex  jus-between align-c padding0-10">
                ...
                <div class="swiper-slide slidepage">
                    <div class="newgoodlsit">
                        <div class="newtop flex jus-between ">
                            <div class="imgl">
                                <img src="__STATIC__/images/newimg/store/goods03.png" alt="">
                            </div>
                            <div class="imgr ">
                                <img src="__STATIC__/images/newimg/store/goods04.png" alt="" style="margin-bottom:4px;">
                                <img src="__STATIC__/images/newimg/store/goods05.png" alt="">
                            </div>
                        </div>

                        <div class="updatelist">
                            <h3 class="font-14">5月20日</h3>
                            <div class="newlsit">
                                <ul class="clearfix">
                                    <li>
                                        <div>
                                            <img src="__STATIC__/images/newimg/store/goods06.png" alt="">
                                        </div>
                                        <div class="padding0-10">
                                            <p class="font-14">2019夏季新款很仙女裙夏季新款很仙女裙</p>
                                            <span class="font-14 maincolor">￥66.69</span>
                                        </div>

                                    </li>
                                    <li>
                                        <div>
                                            <img src="__STATIC__/images/newimg/store/goods07.png" alt="">
                                        </div>
                                        <div class="padding0-10">
                                            <p class="font-14">2019夏季新款很仙女裙夏季新款很仙女裙</p>
                                            <span class="font-14 maincolor">￥66.69</span>
