<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"./application/seller/new/admin\login.html";i:1559804576;}*/ ?>
    	...
    	<div class="sller_login_warp">
            ...
            <div class="ecsc-login-container">
                ...
                <div class="login-right">
                	<div class="login-logo"><img src="__PUBLIC__/static/images/seller/v3.png" /></div>
                    <div class="items">
