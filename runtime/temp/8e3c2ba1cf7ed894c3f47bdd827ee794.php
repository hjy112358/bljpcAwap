<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"./template/mobile/new/payment\payment.html";i:1556698550;}*/ ?>
    	...
    	<div class="wihe-ee">
            ...
            <br>
            	...
            	<div class="fail-fasu">
                	...
                	<p>支付完成</p>
                    <br>
                    <a href="<?php echo U('Mobile/Cart/cart4',array('order_id'=>$order_id,'master_order_sn'=>$master_order_sn)); ?>">支付成功</a>
                </div>
            	...
            	<div class="success-fasu">
                	...
                	<p>支付遇到问题</p>
                    <br>
                    <a href="<?php echo U('Mobile/Cart/cart4',array('order_id'=>$order_id,'master_order_sn'=>$master_order_sn)); ?>">支付失败</a>
                </div>
           
            <div class="re-qtzfgg">
            	<a href="<?php echo U('Mobile/Cart/cart4',array('order_id'=>$order_id,'master_order_sn'=>$master_order_sn)); ?>">返回选择其他支付方式</a>
            </div>
        </div>
    </div>
</body>
