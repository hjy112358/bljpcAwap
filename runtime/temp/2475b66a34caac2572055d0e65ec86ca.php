<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"./application/seller/new/order\underorder.html";i:1560760351;s:41:"./application/seller/new/public\head.html";i:1559726203;s:41:"./application/seller/new/public\left.html";i:1491382652;s:41:"./application/seller/new/public\foot.html";i:1557888501;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<div class="main-content" id="mainContent">
    ...
    <form method="get" action="<?php echo U('order/underorder'); ?>" id="search-form2">
          ...
          <td class="w378">
             ...
             <tr> 
                    ...
                    <td><select name="pay_code" class="w150 w160 di-in">
                              ...
                              <option value="alipayMobile">支付宝支付</option>
                              <option value="appWeixinPay">微信支付</option>
	...
	<table class="ncsc-default-table">
	  <thead>
	    <tr nc_type="table_header">
	      <th class="w30">订单编号</th>
	      <th class="w50">付款人</th>
	      <th class="w50"> 总金额</th>
	      <th class="w100">应付金额</th>
	      ...
	      <th class="w100">下单时间</th>
	  	  ...
	  	  <tbody>
	  	  	  <?php if(is_array($orderList) || $orderList instanceof \think\Collection): if( count($orderList)==0 ) : echo "" ;else: foreach($orderList as $key=>$vo): ?>
		      <tr>
		      <td class="trigger"><?php echo $vo['order_sn']; ?></td>
		     
		     
            <td class="trigger"><?php echo $vo['user_id']; ?>::<?php echo $vo['nickname']; ?></td>
		
		      <td>&yen;<?php echo $vo['total_amount']; ?></td>
		      <td><span>&yen;<?php echo $vo['total_amount']; ?></span></td>
              <td><span><?php if($vo['pay_status'] == 1): ?>已支付<?php else: ?>未支付<?php endif; ?></span></td>
              <td><span><?php echo $vo['pay_name']; ?></span></td>
              <td><span><?php echo date('Y-m-d H:i',$vo['add_time']); ?></span></td>
