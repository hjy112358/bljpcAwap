<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view2/store\store_list.html";i:1491382650;s:44:"./application/admin/view2/public\layout.html";i:1491382650;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<div class="sDiv">
					<div class="sDiv2" style="margin-right: 10px;border: none;">
						<select name="grade_id" class="form-control">
							...
							<?php if(is_array($store_grade) || $store_grade instanceof \think\Collection): $k = 0; $__LIST__ = $store_grade;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k;?>
					...
					<div class="sDiv2" style="margin-right: 10px;border: none;">
						<select name="sc_id" class="form-control">
							...
							<?php if(is_array($store_class) || $store_class instanceof \think\Collection): $k = 0; $__LIST__ = $store_class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k;?>
								<option value="<?php echo $k; ?>" <?php if(\think\Request::instance()->get('sc_id') == $k): ?>selected<?php endif; ?>><?php echo $item; ?></option>
							<?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
					</div>
					<div class="sDiv2" style="margin-right: 10px;border: none;">
