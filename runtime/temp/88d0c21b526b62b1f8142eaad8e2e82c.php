<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/view2/goods\categoryList.html";i:1557134267;s:44:"./application/admin/view2/public\layout.html";i:1491382650;}*/ ?>
<!doctype html>
<html>
<head>
          ...
          <tr data-level="<?php echo $vo[level]; ?>" parent_id_path ="<?php echo $vo['parent_id_path']; ?>" class="parent_id_<?php echo $vo['parent_id']; ?>" nctype="0" <?php if($vo[level] > 1): ?> style="display:none;"<?php endif; ?>>
              ...
              <!-- <td class="sort">
                <div style="text-align: center; width: 60px;">
                  <input type="text" onKeyUp="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" onChange="changeTableVal('goods_category','id','<?php echo $vo['id']; ?>','commission',this)" size="4" value="<?php echo $vo['commission']; ?>" />
                </div>
              </td>       
              <td class="sort">
                <div style="text-align: center; width: 60px;">
