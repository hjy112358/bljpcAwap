<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:38:"./template/mobile/new/user\points.html";i:1558681233;s:40:"./template/mobile/new/public\header.html";i:1556698550;s:38:"./template/mobile/new/public\menu.html";i:1556698550;s:44:"./template/mobile/new/public\footer_nav.html";i:1557372944;s:42:"./template/mobile/new/public\wx_share.html";i:1556698550;}*/ ?>
<!DOCTYPE html >
<html>
<head>
    ...
    <div id="tbh5v0">
        <div class="pbox">
            ...
            <div class="il_nav" id="J_il_nav">
                <a href="<?php echo U('User/points',array('type'=>'all')); ?>" <?php if($type == 'all'): ?>class="active"<?php endif; ?>
                    data-list="1">全部</a>
                <a href="<?php echo U('User/points',array('type'=>'recharge')); ?>" <?php if($type == 'recharge'): ?>class="active"<?php endif; ?> data-list="2">充值记录</a>
                <a href="<?php echo U('User/points',array('type'=>'points')); ?>" <?php if($type == 'points'): ?>class="active"
                    <?php endif; ?> data-list="3">积分</a>
            </div>
            <!-- 积分导航 E -->
        ...
        -->
            <ul class="il_list all_score" id="J_il_list_1">
                <?php if($type == 'recharge'): if(is_array($account_log) || $account_log instanceof \think\Collection): if( count($account_log)==0 ) : echo "" ;else: foreach($account_log as $key=>$vo): ?>
                        <li class="list_add J_add">
                            <div class="td_l">
                                <p>充值金额: <?php echo $vo['account']; ?></p>
                                <p>支付状态:<?php if($vo[pay_status] == 0): ?>待支付&nbsp;&nbsp;<a
                                            href="<?php echo U('User/recharge',array('order_id'=>$vo[order_id])); ?>"
                                            class="">详情</a>
                    ...
                    <?php endforeach; endif; else: echo "" ;endif; else: if(is_array($account_log) || $account_log instanceof \think\Collection): if( count($account_log)==0 ) : echo "" ;else: foreach($account_log as $key=>$vo): ?>
                        <li class="list_add J_add">
                            <div class="td_l">
