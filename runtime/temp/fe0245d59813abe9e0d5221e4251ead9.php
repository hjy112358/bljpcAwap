<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:40:"./template/pc/rainbow/newjoin\index.html";i:1491382656;s:40:"./template/pc/rainbow/public\header.html";i:1550417737;s:40:"./template/pc/rainbow/public\footer.html";i:1491382656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="tpshop-tm-hander p">
    ...
    <div class="nav-middan-z p">
        <div class="header w1224">
			...
			<div class="ecsc-join">
			    <?php $pid =2;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1559005200 and end_time > 1559005200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
...
.settled-merchants-title {width: 990px;text-align: left;font: 400 24px/24px '微软雅黑';border-bottom: 1px solid #e8e8e8;}
			...
			<div class="zs_kv_box" id="pic_change">
				...
				<div class="p_c_list" id="p_c_list" style="width: 1190px; height: 300px;">
					<ul style="height: 300px;">
						<li style="width: 1190px; height: 300px;"><a href="#" target="_blank"><img src="__STATIC__/images/ChEi1VZOfxKAIxDuAAMyOSmDp6o48200_980x260.jpg" style="width: 980px; height: 260px;"></a></li>
						<li style="width: 1190px; height: 300px;"><a href="" target="_blank"><img src="__STATIC__/images/ChEi2VarLLqAKgfNAAGy66GXUgM18600_718x252.jpg" style="width: 980px; height: 260px;"></a></li>
						<li style="width: 1190px; height: 300px;"><a href="" target="_blank"><img src="__STATIC__/images/ChEi11ZOf0CAIQpJAALagKKoyh451000_980x260.jpg" style="width: 980px; height: 260px;"></a></li>
						<li style="width: 1190px; height: 300px;"><a href="" target="_blank"><img src="__STATIC__/images/ChEbu1ZOf1SAUc92AAGT_H-E6dI45200_980x260.jpg" style="width: 980px; height: 260px;"></a></li>
					</ul>
				</div>
            ...
            <ul class="merchants-list" id="merchants-list">
		  	...
		  	<?php
                    ...
                    <div class="merchants-tab-con" style="display: <?php if($k == 0): ?>block <?php else: ?>none<?php endif; ?>;">
                        ...
                        <img src="<?php echo $v2[logo]; ?>" width="164" height="58" alt="<?php echo $v2[name]; ?>">
						<?php endforeach; ?>
                    </div>
			  <?php endforeach; ?>
            </div>
