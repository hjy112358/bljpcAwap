<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:55:"./template/mobile/new/activity\discount_goods_list.html";i:1558678772;s:38:"./template/mobile/new/public\menu.html";i:1556698550;s:40:"./template/mobile/new/public\footer.html";i:1556698550;s:44:"./template/mobile/new/public\footer_nav.html";i:1557372944;s:42:"./template/mobile/new/public\wx_share.html";i:1556698550;}*/ ?>
<html>
...
<div class="goods_nav hid" id="menu">
  ...
  <div id="J_ItemList" style="margin-top:15px;">
    <?php if(is_array($prom_list) || $prom_list instanceof \think\Collection): if( count($prom_list)==0 ) : echo "" ;else: foreach($prom_list as $key=>$vo): ?>
      <ul class="single_item info" id="more_element_3">
        <div class="huodong">
          <a href="<?php echo U('Activity/discount_goods_list'); ?>">
            <div class="activity_name"><i></i><strong>[自营商品]<?php echo $vo['name']; ?></strong><span>网站自营</span></div>
            <em><span>优惠结束时间：<?php echo date('Y-m-d',$vo['end_time']); ?></span><img src="<?php echo $vo['prom_img']; ?>"></em>
          </a>
        </div>
      </ul>
    <?php endforeach; endif; else: echo "" ;endif; ?>
    <div class="more_loader_spinner" style="display: block;">
  <div class="more_loader_spinner" style="display: block;"><div class="jiazai"><em></em><span>亲，已经没有东西了哦！</span><em></em></div></div>
    </div>
  </div>
  <script>
    function goTop() {
