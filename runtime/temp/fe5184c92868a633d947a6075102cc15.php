<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./template/mobile/new/patternb\scaleOut.html";i:1562894346;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="myteam scalebody">
    <div class="wrap">
        <div class="maincolorbg  tophead" style="text-align: center">
            ...
            <p class="font-18" style="line-height:60px;margin-left: 0">卖出</p>
