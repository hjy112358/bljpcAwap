<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:38:"./template/mobile/new/user\coupon.html";i:1562899989;s:40:"./template/mobile/new/public\header.html";i:1562843062;s:38:"./template/mobile/new/public\menu.html";i:1556698550;s:40:"./template/mobile/new/public\footer.html";i:1556698550;}*/ ?>
<!DOCTYPE html >
<html>
<head>
        ...
        <aside class="top_bar">
          <div onClick="show_menu();$('#close_btn').addClass('hid');" id="show_more"><a href="javascript:;"></a> </div>
			...
			<!-- <div class="maincolorbg flex jus-between align-c tophead">
				...
				<p class="font-18">我的优惠券</p>
				<a href=""></a>
			</div> -->

			<!-- <div class="maincolorbg tophead " id="topAnchor" style="text-align: center;">
				<p class="font-18" style="margin-left:0">我的优惠券</p>
			</div> -->
  </div>
</header>
...
<div class="order">
	...
	<div class="Emain" id="user_goods_ka_1" style="display:block">
		<?php if(is_array($coupon_list) || $coupon_list instanceof \think\Collection): $i = 0; $__LIST__ = $coupon_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$coupon): $mod = ($i % 2 );++$i;?>
			<div class="offercard_page offercard_type<?php if($_GET['type'] == 0): ?>1<?php endif; if($_GET['type'] == 1): ?>2<?php endif; if($_GET['type'] == 2): ?>0<?php endif; ?>">
...
<?php if(!(empty($coupon_list) || ($coupon_list instanceof \think\Collection && $coupon_list->isEmpty()))): ?>	
