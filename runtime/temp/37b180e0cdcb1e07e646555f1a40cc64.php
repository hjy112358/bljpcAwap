<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:46:"./template/mobile/new/cart\ajax_cart_list.html";i:1558511285;}*/ ?>
<style type="text/css">
	.page-shopping .bottom-panel{display: flex;}
	.page-shopping .bottom-panel .info{width: 50%;}
  ...
  .storeDetail{color:#dcdcdc;margin-left:15px}
  .shop_title{height:40px;border-bottom:0}
</style>
 <?php if(is_array($cartList) || $cartList instanceof \think\Collection): if( count($cartList)==0 ) : echo "" ;else: foreach($cartList as $k=>$v): ?>
    <div  class="block" style="margin-top:0px;">
      <div class="shop_title" >
        <div class="fl"><a class="shopLink eclipse" href="javascript:void(0);"><?php echo $storeList[$v[store_id]]; ?><span class="storeDetail font-13">></span></a>
       ...
       <div class="item">
         <div class="inner">
           ...
           <div style=" position:absolute; right:0px; top:20px; width:100px; height:98px;">
             <div class="price">
               <!-- <span class="mar_price">￥<?php echo $v['attr_value']; ?></span> -->
               <br>
...
<?php endforeach; endif; else: echo "" ;endif; if(empty($cartList)): ?>         
...
<script type="text/javascript">
 ...
 <?php else: ?>
	 <div class="bottom-panel" style="display:flex">
	   ...
	   <div class="info" >
	     <span class="hot" id="cart_amount_desc"><em style="color:#c2c2c2">合计：</em>￥<?php echo $total_price['total_fee']; ?></span>
	     <br>
	     <!-- <span class="hot_text">不含运费</span> -->
	   </div>
	   <div class="right">
	     <input type="button" href="javascript:void();"  onclick="return selcart_submit();" class="xm-button " value="去结算(1)"></div>
	</div>
<?php endif; ?> 
<script type="text/javascript">
