<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"./template/mobile/new/user\changephone.html";i:1558507145;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="">
    <div class="wrap">
        ...
        <div class="maincolorbg flex jus-between align-c tophead">
            ...
            <p class="font-18">更改手机号</p>
            <a href=""></a>
        </div>
        <div class="datelist bindphone changephone">
            <div class="">
            ...
            <div class="forminput">
                ...
                <div class="flex jus-between lastinput align-c">
