<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./template/mobile/new/order\partner_all.html";i:1558946764;s:46:"./template/mobile/new/public\foot_partner.html";i:1559462230;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="wrap storelist partnerlist">
        ...
        <div class="tablist">
            <div id="leftTabBox" class="tabBox ">
                <div class="bigGoods clearfix">
                    <div class="bigGoodsimg">
                        <img src="__STATIC__/images/newimg/partner/bigoods.png" alt="">
                    </div>
                    <div class="goodmsg">
                        <p class="font-11 colb3">紫砂功夫茶具套装</p>
                        <p class="font-13 colb3">陶瓷茶杯电热磁炉茶台</p>
                        <div class="discoutmsg flex jus-between align-c">
                            <p class="price font-10">￥<span class="font-17 font-bold">10000</span></p>
                            <p class="inventory">库存200</p>
                ...
                <div class="bd">
                    ...
                    <ul>
                        <li>
                            <div class="sgoodsbox ">
                                <div class="sgoods clearfix sgoodsT">
                                    <div class="sgoodslist sgoodslistl fl">
                                        <div class="sgoodimg">
                                            <img src="__STATIC__/images/newimg/partner/smallgoods.png" alt="">
                                        </div>
                                        <div class="discoutmsg flex jus-between align-c">
                                            <p class="price font-10">￥<span class="font-17 font-bold">10000</span>
                                            </p>
                                            <p class="inventory">库存200</p>
                                            <a href="javascript:void(0)" class="font-10 battle">马上抢</a>
                                            <span class="triangle"></span>
                                    ...
                                    <div class="sgoodslist sgoodslistr fr">
                                        <div class="sgoodimg">
                                            <img src="__STATIC__/images/newimg/partner/smallgoods.png" alt="">
                                        </div>
                                        <div class="discoutmsg flex jus-between align-c">
                                ...
                                <div class="sgoods clearfix sgoodsB">
                                    <div class="sgoodslist sgoodslistl fl">
                                        <div class="sgoodimg">
                                            <img src="__STATIC__/images/newimg/partner/smallgoods.png" alt="">
                                        </div>
    ...
    <div class="mark hidden">
        ...
        <div class="agreementbox">
            <div class="agreement">
                ...
                <p>（二）本合同一式两份，甲、乙双方各执一份； 　　</p>
                <p>（三）本合同经甲乙双方签名、盖章后生效。 </p>
                <p> </p>
                <p>甲方（代表）（盖章）：　　　　　　 乙方（盖章）：</p>
                <p>甲方（签字）：_________　　 乙方（签字）：_________</p>
        ...
        <img src="__STATIC__/images/newimg/onebuy/close.png" alt="" class="closemark">
    </div>
