...
<div class="Wallet">
	<div class="cash_num bb1">
        <form action="" method="post" enctype="multipart/form-data" name="distribut_form" id="distribut_form">
            ...
            <img class="po-ab to0" id="verify_code_img" width="100" height="30" src="<?php echo U('Distribut/verify',array('type'=>'withdrawals')); ?>"  onclick="verify(this)" />
            </p>
