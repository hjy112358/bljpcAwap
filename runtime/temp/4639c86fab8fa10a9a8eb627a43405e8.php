<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"./template/mobile/new/public\dispatch_jump.html";i:1562899065;}*/ ?>
<!DOCTYPE html >
<html>
<head>
<meta name="Generator" content="TPSHOP v1.1" />
  ...
  <link rel="stylesheet" href="__STATIC__/css/public.css?time=<?php echo time()?>" >
  </head>

<body>
<!-- <header class="header_03">
  <div class="nl-login-title" style="background:#ff4c4c">
     <div class="h-left">
      <a class="sb-back" href="javascript:history.back(-1)" title="返回"></a>
    </div> 
    <span style="text-align:center;color:#fff">系统提示</span>
  </div>
</header> -->
<div class="ng-form-zhu" style="text-align: center;font-size:16px;">
  ...
  <div class="tips">
      ...
      <a href="<?php echo U('Index/indexnew'); ?>" style="color: #666;" >
