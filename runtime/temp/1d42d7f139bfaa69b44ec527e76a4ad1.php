<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./template/pc/rainbow/newjoin\agreement.html";i:1491382656;s:45:"./template/pc/rainbow/public\sign-header.html";i:1491382656;s:40:"./template/pc/rainbow/public\footer.html";i:1491382656;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="gome-wrap bg">
    ...
    <div class="gome-layout-area pb50 clearfix">
        ...
        <label class="agree clearfix" >
            <input type="checkbox" hidefocus="ture" name="check2" id="check2" class="inputcheck" />我已阅读并同意接受以上所有协议</label >
        <div class="gome-btn">
