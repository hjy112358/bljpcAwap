<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:50:"./application/seller/new/admin\sellerRegThree.html";i:1561537936;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="authentication ">
                    <form class="layui-form" action="">
                        ...
                        <div class="inputbox ">
                            ...
                            <div class="layui-form-item layui-form-text">
                                ...
                                <div class="layui-input-block">
                                    <textarea placeholder="输入你的信息" class="layui-textarea" rows="5"></textarea>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <div class="layui-inline">
                        ...
                        <div class="inputbox ">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" class="layui-input" id="validity" placeholder=" - ">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item layui-form-text">
                                ...
                                <div class="layui-input-block">
                                    <textarea placeholder="" class="layui-textarea" rows="5"></textarea>
                                </div>
                            </div>
                        ...
                        <div class="authenticationbtn">
                            <a href="<?php echo url('admin/sellerRegTwo'); ?>" style="margin-right: 155px"
                                class="btnNO arthenbtn">上一步</a>
                            <a href="<?php echo url('admin/sellerRegFour'); ?>" class="nextStep">下一步</a>
                        </div>
                    </form>
                </div>
            </div>
