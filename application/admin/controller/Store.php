...
class Store extends Base{
	...
	public function qrcode()
	{
		...
		$store_qrcode = Db::name('store')->where('store_id',$store_id)->field('store_qrcode')->find();
	...
	public function qrcodes()
    {
        ...
        $url = "http://abc.fyc365.cn/mobile/order/pay/store_id/".$store_id."/mode/".$mode;
	...
	public function save_qrcode()
	{
		...
		$result = Db::name('store')->where('store_id',$store_id)->save([
			'store_qrcode'=>$qr_url
		]);
